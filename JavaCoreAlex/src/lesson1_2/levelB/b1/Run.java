...
В многострочном комментарии напишите объяснение почему мы получили разные значения переменных varInt и varByte.
 */
public class Run {
    public static void main(String[] args) {
        ...
        /*В данном случае число 130 вне диапазона для типа byte (от -128
до 127), поэтому произойдет усечение значения.*/
    }
}
